...
const LoginForm = () => {
  ...
  return (
    <div className="xs:w-full xs:p-4 mb-4 rounded-2xl border border-gray-300 lg:w-1/3 lg:px-10 lg:py-12 dark:border-neutral-300 dark:lg:bg-transparent">
      <Formik
        initialValues={{
          email: '',
          password: ''
      ...
      >
        {({ isSubmitting }) => (
          <>
            <p className="xs:text-xl font-primary mb-4 font-semibold lg:text-left lg:text-4xl">
              Admin login
            </p>
            <Form>
              ...
              <motion.div className="mb-4" variants={childVariant}>
                <label htmlFor="password" className="formLable">
                  Password <Asterisk className="inline-block align-super text-red-500" size={10} />
                </label>
                <Field type="password" name="password" className="formInput" />
